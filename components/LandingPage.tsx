...
const LandingPage = () => {
  return (
    ...
    >
      ...
      >
        <NavCircle src="/images/climbing_yosemite_square.jpeg" text="About" />
        <NavCircle src="/images/skate_square.jpg" text="Projects" />
        <NavCircle src="/images/flip_square.jpg" text="Contact" />
        <div
