...
const LandingPage = () => {
  return (
    ...
    >
      ...
      >
        <NavCircle src="/images/climbing_yosemite-square.jpeg" text="About" />
        <NavCircle src="/images/skate-square.jpg" text="Projects" />
        <NavCircle src="/images/flip-square.jpg" text="Contact" />
        <div
